...
//
// Every test here execs the fixture as a real child process, which is why the
// file is tagged: it crosses a process boundary and is excluded from the
// default `go test ./...` run. The fixture's pure-function tests live untagged
// in server_test.go.
//
